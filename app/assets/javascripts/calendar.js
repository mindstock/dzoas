...
write("<table border='0' bgcolor='#ffffff' width='100%' height='200' aling=center>");
write("<TR>");
...
write("<TABLE width='100%' heigth=30><TR><TD align='center'>");
...
write("<B style='color:\"#ff6600\"; cursor:hand; font-size:12px' onClick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=\"#000000\"' onMouseOut='this.style.color=\"#ff6600\"'>选择: "+giYear+"/"+giMonth+"/"+giDay+"</B>");
write("</td></tr></table>");
write("</TD></TR>");
write("</TABLE></Div>");
